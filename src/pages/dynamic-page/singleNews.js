            ...
            return (
                <div className="singleNews-page">
                    <div className="singleNews-header-container">
                        <img src={`https://source.unsplash.com/1600x900/?${currentNews[0].title}-fund/?${currentNews[0].description}-technology`}/>
                        <div className="singleNews-header-text">
                            <h1>{currentNews[0].title}</h1>
                            <div className="singleNews-spans">
                                <span>GLOBAL FINANCE</span>
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{fill: 'rgba(255, 255, 255, 1)'}}><path d="M21 20V6c0-1.103-.897-2-2-2h-2V2h-2v2H9V2H7v2H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2zM9 18H7v-2h2v2zm0-4H7v-2h2v2zm4 4h-2v-2h2v2zm0-4h-2v-2h2v2zm4 4h-2v-2h2v2zm0-4h-2v-2h2v2zm2-5H5V7h14v2z"></path></svg> {currentNews[0].pubDate.substring(0,17)}</span>
